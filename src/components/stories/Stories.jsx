...
export default function Stories() {
  ...
  const stories = [
    ...
    { id: 4, type: "image", src: tama, title: "Сторис 4" },
    { id: 5, type: "video", src: video3 },
    { id: 6, type: "image", src: shrek, title: "сторис 6 " },
    { id: 7, type: "image", src: love, title: "сторис 7" },
  ];
  ...
  return (
    ...
    <div className="flex space-x-4  overflow-x-auto p-2 scrollbar-hide max-w-full sm:max-w-[500px] mx-auto">
        {stories.map((story, index) => (
            <div
                key={story.id}
                className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[url('https://pictures.pibig.info/uploads/posts/2023-04/1680921090_pictures-pibig-info-p-risunki-yodi-milie-vkontakte-9.png')] bg-cover cursor-pointer overflow-hidden duration-300 
    ...
    {activeStory && (
        <div className="fixed top-[140px] z-50 inset-0 flex items-center justify-center bg-white bg-opacity-90 p-4">
            <div className="relative w-full max-w-[500px] h-auto sm:h-[520px] flex items-center justify-center">
