...
export default function Footer() {
  ...
  <div className="w-full max-w-[1400px] m-auto">
    ...
    <div className="flex flex-wrap justify-between gap-x-7 gap-y-8">
      <div className="space-y-4 w-full sm:w-auto">
        ...
        <div className="flex gap-4 items-center mt-[14px]">
          <div className="flex items-center gap-2">
            ...
            <a href="https://api.whatsapp.com/send?phone=78007707021"><h3 className="text-sm">WhatsApp</h3></a>
          </div>
          <div className="flex items-center gap-2">
            <RiTelegramLine size={24} />
            <a href="https://t.me/GoldappleSupportBot"><h3 className="text-sm">Telegram</h3></a>
          </div>
        </div>
      </div>
      <div className="space-y-4 w-full sm:w-auto">
        ...
        <Link to='shops'><h3 className="text-sm opacity-75">наши магазины</h3></Link>
      </div>
      <div className="space-y-4 w-full sm:w-auto">
    ...
    <div className="flex flex-wrap gap-8 justify-around mt-[20px]">
