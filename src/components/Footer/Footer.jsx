...
export default function Footer() {
  return (
    <footer className="bg-black text-white">
      <div className="max-w-[1400px] w-full mx-auto px-4 md:px-8 pt-6 pr-3">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-4 pt-3 text-sm opacity-75">
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers3">Политика обработки данных</Link></li>
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers2">Документы сайта</Link></li>
              <li><Link onClick={() => window.scrollTo(0, 0)} to="shops">Наши магазины</Link></li>
            </ul>
          </div>
          <div>
            <h1 className="text-lg font-semibold">Клиентам</h1>
            <ul className="space-y-4 pt-3 text-sm opacity-75">
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers4">Заказы и доставка</Link></li>
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers5">Возврат товара</Link></li>
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers6">Бонусная программа</Link></li>
            </ul>
          </div>
          <div>
            <h1 className="text-lg font-semibold">Контакты</h1>
            <ul className="space-y-4 pt-3 text-sm opacity-75">
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers7">Общие контакты</Link></li>
              <li><Link onClick={() => window.scrollTo(0, 0)} to="footers7">Маркетинг и реклама</Link></li>
              <li><a href="https://goldapple.ru/lp/advcake">Партнёрская программа</a></li>
            </ul>
          </div>
        </div>
        <hr className="border-t border-gray-700 my-6" />
        <div className="flex flex-col md:flex-row pb-6 justify-between items-center gap-6">
          <div className="flex gap-4">
            ...
            <a href="https://www.youtube.com/channel/UC5vsg5-xOIT0N-jilqFSz_w" className="hover:opacity-75">
              <img src={uteb} alt="YouTube" className="w-6 h-6" />
            </a>
          </div>
          <div className="flex flex-wrap justify-center md:justify-start gap-3">
            <a href="https://appgallery.huawei.com/app/C103551593">
              <img src={app} alt="App Gallery" className="w-20 h-6 hover:opacity-75" />
            </a>
            <a href="https://apps.apple.com/ru/app/%D0%B7%D0%BE%D0%BB%D0%BE%D1%82%D0%BE%D0%B5-%D1%8F%D0%B1%D0%BB%D0%BE%D0%BA%D0%BE-%D0%BE%D0%BD%D0%BB%D0%B0%D0%B9%D0%BD-%D0%BF%D0%BE%D0%BA%D1%83%D0%BF%D0%BA%D0%B8/id1154436683">
              <img src={apps} alt="App Store" className="w-20 h-6 hover:opacity-75" />
            </a>
            <a href="https://play.google.com/store/apps/details?id=goldapple.ru.goldapple.customers">
              <img src={google} alt="Google Play" className="w-20 h-6 hover:opacity-75" />
            </a>
            <a href="https://apps.rustore.ru/app/goldapple.ru.goldapple.customers">
              <img src={rus} alt="RuStore" className="w-20 h-6 hover:opacity-75" />
            </a>
          </div>
