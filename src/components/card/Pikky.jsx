...
import pikky1 from '../../assets/aiba/pikky.webp'
import { IoHeartOutline } from 'react-icons/io5'
import { BsBasket } from 'react-icons/bs'
import { Link } from 'react-router-dom'
import Slider from 'react-slick';
import { pikky } from "./data";

export default function Pikky() {
    const settings = {
        dots: true,
        infinite: true,
        speed: 500,
      ...
      return (
        <div className="mt-[100px] w-[1400px] h-[700px] mb-[100px]  m-auto relative" >
                ...
                <div key={product.id} className="px-2">
                  <div className="bg-white p-4 rounded-lg relative">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <h2 className="text-xl font-bold">от {product.price}</h2>
