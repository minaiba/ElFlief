  ...
  const setting = {
    ...
    <div className="mt-[100px] w-[1400px] h-[700px] mb-[25px]  m-auto relative" >
      ...
      <div className="mt-6 w-[80%] absolute bottom-[0px] left-[10%]" >
        <Slider {...setting} className='flex gap-12'>
          {products.map((pro) => (
            <div key={pro.id} className="px-2">
              <div className="bg-white p-4 rounded-lg relative">
                <img src={pro.image} className="w-full h-[250px] object-cover rounded-lg" alt={pro.name} />
                ...
                <p className="mt-4 text-sm text-gray-600">{pro.description}</p>
