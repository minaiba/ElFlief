...
export default function Discount() {
  ...
  return (
    ...
    <div className='mb-20 overflow-x-hidden'>
      <h1 className='text-7xl font-bold text-white absolute mt-[580px] ml-[300px]'>скидки до −50%</h1>
      ...
      <div className='w-[1400px] m-auto'>
        ...
        <div className='mt-[20px]'>
          <div className='flex mt-[20px] '>
            {every.map((eve) => (
              <div key={eve.id} className='cursor-pointer' onClick={() => setSelectedProduct(eve)}>
                ...
                <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{eve.discount}</button>
                <img src={imageHovered === eve.id ? eve.imgAlt : eve.img} onMouseEnter={() => handleMouseEnter(eve.id)} onMouseLeave={handleMouseLeave} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{eve.category}</h3>
                <h1 className='hover:text-[#9ca887] w-[300px] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{eve.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] mt-[5px] ml-[240px]'>{eve.price}</h1>
              </div>
            ))}
            {lips.map((lip) => (
              <div key={lip.id} className='ml-[60px] cursor-pointer' onClick={() => setSelectedProduct(lip)}>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 ml-[265px] mt-[10px] w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] hover:text-green-500 mt-[205px] w-[20px] h-[20px]' /></Link>
                <button className=' w-[40px] h-[40px] bg-[#ede370] text-[#221d1d] font-bold absolute'>{lip.discount}</button>
                <img src={lip.img} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono w-[300px] mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{lip.category}</h3>
                <h1 className='hover:text-[#9ca887] text-2xl font-medium w-[300px] ' style={{ direction: 'rtl', textAlign: 'right' }}>{lip.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[210px] mt-[5px]'>{lip.price}</h1>
              </div>
            ))}
            {longsliv.map((lon) => (
              <div key={lon.id} className='ml-[90px] cursor-pointer' onClick={() => setSelectedProduct(lon)}>
                ...
                <img src={imageHovered === lon.id ? lon.imgAlt : lon.img} className='h-[500px] w-[650px] ' onMouseEnter={() => handleMouseEnter(lon.id)} onMouseLeave={handleMouseLeave} />
                <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px] ml-[20px]'>{lon.category}</p>
                <h1 className='hover:text-[#9ca887] text-4xl font-medium ml-[20px]' >{lon.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] ml-[20px]'>{lon.price}</h1>
              </div>
            ))}
          </div>
          <div className='flex'>
            {shik.map((shi) => (
              <div key={shi.id} className='mt-[-130px] cursor-pointer w-[1400px]' onClick={() => setSelectedProduct(shi)}>
                <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] hover:text-red-500 h-[20px] ml-[580px] mt-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] ml-[585px] mt-[460px] hover:text-green-500' /></Link>
                <button className='bg-[#ede370] text-[#221d1d] font-bold w-[45px] h-[40px] absolute'>{shi.discount}</button>
                <img src={imageHovered === shi.id ? shi.imgAlt : shi.img} onMouseEnter={() => handleMouseEnter(shi.id)} onMouseLeave={handleMouseLeave} className='h-[500px] w-[650px]' />
                <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px]  ml-[20px]'>{shi.category}</p>
                <h1 className='hover:text-[#9ca887] text-4xl font-medium  ml-[20px]'>{shi.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[20px] mt-[5px]'>{shi.price}</h1>
              </div>
            ))}
            {pomidor.map((pom) => (
              <div key={pom.id} onClick={() => setSelectedProduct(pom)} className='ml-[90px] cursor-pointer mt-[90px]' onMouseEnter={() => handleMouseEnter('blush')} onMouseLeave={handleMouseLeave}>
                ...
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{pom.discount}</button>
                <img src={imageHovered === pom.id ? pom.imgAlt : pom.img} onMouseEnter={() => handleMouseEnter(pom.id)} onMouseLeave={handleMouseLeave} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}> {pom.title}</h3>
                <h1 className='hover:text-[#9ca887] w-[300px] font-medium text-2xl' style={{ direction: 'ltr', textAlign: 'left' }}> {pom.title} </h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] '>{pom.price}</h1>
              </div>
            ))}
            {clean.map((cl) => (
              <div key={cl.id} className='ml-[60px] cursor-pointer mt-[90px]' onClick={() => setSelectedProduct(cl)}>
                <Link to="/favorites"><IoHeartOutline className='absolute  ml-[265px] mt-[10px] hover:text-red-500 w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
                <button className='absolute bg-[#ede370] text-[#221d1d]  w-[40px] h-[40px]  font-bold'>{cl.discount}</button>
                <img src={imageHovered === cl.id ? cl.imgAlt : cl.img} onMouseEnter={() => handleMouseEnter(cl.id)} onMouseLeave={handleMouseLeave} className='w-[300px] h-[240px] ' />
                <h3 className=' hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}> {cl.category}</h3>
                <h1 className=' hover:text-[#9ca887] w-[300px] text-2xl font-medium' style={{ direction: 'ltr', textAlign: 'left' }}> {cl.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] mt-[5px] text-2xl'>{cl.price}</h1>
              </div>
            ))}
          </div>
          <div className='flex mt-[100px]'>
            {avatar.map((ava) => (
              <div key={ava.id} className='cursor-pointer' onClick={() => setSelectedProduct(ava)}>
                <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] mt-[10px] hover:text-red-500 w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{ava.discount}</button>
                <img src={ava.img} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{ava.category}</h3>
                <h1 className='hover:text-[#9ca887] w-[300px] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{ava.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] mt-[5px] ml-[240px]'>{ava.price}</h1>
              </div>
            ))}
            {tush.map((tu) => (
              <div key={tu.id} onClick={() => setSelectedProduct(tu)} className='ml-[60px] w-[300px] cursor-pointer'>
                <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] mt-[10px] hover:text-red-500 w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] hover:text-green-500 mt-[205px] w-[20px] h-[20px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d] w-[40px] h-[40px]  font-bold absolute'>{tu.discount}</button>
                <img src={imageHovered === 'парфюм' ? tu.imgAlt : tu.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('парфюм')} onMouseLeave={handleMouseLeave} />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{tu.category}</h3>
                <h1 className='hover:text-[#9ca887] w-[300px] text-2xl font-medium' style={{ direction: 'rtl', textAlign: 'right' }}>{tu.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] ml-[230px]'>{tu.price}</h1>
              </div>
            ))}
            {mist.map((mi) => (
              <div className='ml-[90px] cursor-pointer ' onClick={() => setSelectedProduct(mi)}>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{mi.discount}</button>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[605px] mt-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] ml-[605px] hover:text-green-500 mt-[460px]' /></Link>
                <img src={mi.img} className=' h-[500px] w-[650px]' />
                <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px] ml-[20px]'> {mi.category}</p>
                <h1 className='hover:text-[#9ca887] text-4xl font-medium ml-[20px]' >{mi.title}</h1>
                <button className=' bg-[#e7e1a2] text-[#221d1d] w-[120px] hover:text-[#9ca887]  ml-[150px] mt-[10px]'>{mi.button}</button>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[-15px] ml-[20px]'>{mi.price}</h1>
              </div>
            ))}
          </div>
          <div className='flex mt-[100px] w-[1400px]'>
            {pial.map((p) => (
              <div key={p.id} className='cursor-ponter' onClick={() => setSelectedProduct(p)}>
                <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] hover:text-red-500 mt-[10px] w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-red-500 w-[20px] h-[20px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{p.discount}</button>
                <img src={p.img} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}> {p.category}</h3>
                <h1 className='hover:text-[#9ca887] w-[300px] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{p.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] mt-[5px] ml-[240px]'>{p.price}</h1>
              </div>
            ))}
            {maska.map((mas) => (
              <div key={mas.id} className='ml-[60px] w-[300px] cursor-pointer' onClick={() => setSelectedProduct(mas)}>
                <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] hover:text-red-500 mt-[10px] w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{mas.discount}</button>
                <img src={imageHovered === 'night' ? mas.imgAlt : mas.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('night')} onMouseLeave={handleMouseLeave} />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}> {mas.category}</h3>
                <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{mas.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] mt-[5px] text-2xl ml-[210px]'>{mas.price}</h1>
              </div>
            ))}
            {bele.map((be) => (
              <div key={be.id} onClick={() => setSelectedProduct(be)} className='w-[300px] cursor-pointer ml-[60px]' onMouseEnter={() => handleMouseEnter('sumka')} onMouseLeave={handleMouseLeave}>
                <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] h-[20px] hover:text-red-500 ml-[265px] mt-[10px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{be.discount}</button>
                <img src={imageHovered === 'sumka' ? be.imgAlt : be.img} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}>{be.category}</h3>
                <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'ltr', textAlign: 'left' }}>{be.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] '>{be.price}</h1>
              </div>
            ))}
            {music.map((mu) => (
              <div key={mu.id} onClick={() => setSelectedProduct(mu)} className='ml-[60px] cursor-pointer w-[300px]'>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 ml-[265px] mt-[10px] w-[20px] h-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  w-[40px] h-[40px] font-bold absolute'>{mu.discount}</button>
                <img src={imageHovered === 'шампунь' ? mu.imgAlt : mu.img} className='w-[300px] h-[240px] ' onMouseEnter={() => handleMouseEnter('шампунь')} onMouseLeave={handleMouseLeave} />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}>{mu.category}</h3>
                <h1 className='hover:text-[#9ca887] text-2xl font-medium ' style={{ direction: 'ltr', textAlign: 'left' }}>{mu.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl  mt-[5px]'>{mu.price}</h1>
              </div>
            ))}
          </div>
          <div className='flex mt-[100px] '>
            {balzam.map((bal) => (
              <div key={bal.id} className='w-[300px] cursor-pointer' onClick={() => setSelectedProduct(bal)}>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[265px] mt-[10px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{bal.discount}</button>
                <img src={imageHovered === 'bee' ? bal.imgAlt : bal.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('bee')} onMouseLeave={handleMouseLeave} />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{bal.category}</h3>
                <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{bal.title}</h1>
                <button className=' bg-[#eae396]  w-[120px] hover:text-[#9ca887]  ml-[180px] mt-[10px]'>{bal.button}</button>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[235px] mt-[-16px]'>{bal.price}</h1>
              </div>
            ))}
            {vitam.map((sam) => (
              <div key={sam.id} onClick={() => setSelectedProduct(sam)} className='w-[300px] cursor-pointer ml-[60px]'>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[265px] mt-[10px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{sam.discount}</button>
                <img src={imageHovered === 'termo' ? sam.imgAlt : sam.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('termo')}
                  onMouseLeave={handleMouseLeave} />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{sam.category}</h3>
                <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{sam.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[210px] mt-[5px]'>{sam.price}</h1>
              </div>
            ))}
            {shamp.map((sam) => (
              <div key={sam.id} onClick={() => setSelectedProduct(sam)} className='ml-[90px] cursor-pointer '>
                <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] h-[20px] ml-[605px] mt-[20px] hover:text-red-500 transition' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] ml-[605px] mt-[460px] hover:text-green-500' /></Link>
                <img src={imageHovered === 'kor' ? sam.imgAlt : sam.img} className='h-[500px] transition w-[650px]' onMouseEnter={() => handleMouseEnter('kor')} onMouseLeave={handleMouseLeave} />
                <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px] ml-[20px]'>{sam.category}</p>
                <h1 className='hover:text-[#9ca887] text-4xl font-medium ml-[20px] w-[500px]  ' >{sam.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] ml-[20px]'>{sam.price}</h1>
              </div>
            ))}
          </div>
          <div className='flex mt-[100px] '>
            {massaj.map((mes) => (
              <div key={mes.id} onClick={() => setSelectedProduct(mes)} className='cursor-pointer' onMouseEnter={() => handleMouseEnter('fen')} onMouseLeave={handleMouseLeave}>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[605px] mt-[20px]' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] hover:text-green-500 ml-[605px] mt-[460px]' /></Link>
                <img src={mes.img} className='h-[500px] w-[650px]' />
                <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px]  ml-[20px]'>{mes.category}</p>
                <h1 className='hover:text-[#9ca887] text-4xl font-medium  ml-[10px]'>{mes.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[10px] mt-[10px]'>{mes.price}</h1>
              </div>
            ))}
            {pled.map((pd) => (
              <div key={pd.id} onClick={() => setSelectedProduct(pd)} className='w-[300px] cursor-pointer ml-[90px]' onMouseEnter={() => handleMouseEnter('fen')} onMouseLeave={handleMouseLeave}>
                <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] mt-[10px]  ml-[265px] ' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
                <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{pd.discount}</button>
                <img src={imageHovered === 'fen' ? pd.imgAlt : pd.img} className='w-[300px] h-[240px]' />
                <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}>{pd.category}</h3>
                <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'ltr', textAlign: 'left' }}>{pd.title}</h1>
                <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] '>{pd.price}</h1>
              </div>
            ))}
            {sergi.map((ser) => (
              <div key={ser.id} onClick={() => setSelectedProduct(ser)} className='w-[300px] cursor-pointer ml-[60px]' onMouseEnter={() => handleMouseEnter('piala')} onMouseLeave={handleMouseLeave}>
                <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] hover:text-red-500 h-[20px] mt-[10px]  ml-[265px] ' /></Link>
                <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
                <button className=' bg-[#ede370] text-[#221d1d]   font-bold w-[40px] absolute h-[40px]'>{ser.discount}</button>
        ...
        <div className='flex mt-[100px]'>
          {avatar.map((ava) => (
            <div key={ava.id} className='cursor-pointer'>
              <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] hover:text-red-500 mt-[10px] w-[20px] h-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d]  font-bold w-[40px] absolute h-[40px]'>{ava.discount}</button>
              <img src={ava.img} className='w-[300px] h-[240px]' />
          ...
          {tush.map((tu) => (
            <div key={tu.id} className='ml-[60px] cursor-pointer w-[300px]'>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 ml-[265px] mt-[10px] w-[20px] h-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d]  w-[40px] h-[40px]  font-bold absolute'>{tu.discount}</button>
              <img src={imageHovered === 'парфюм' ? tu.imgAlt : tu.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('парфюм')} onMouseLeave={handleMouseLeave} />
          ...
          {mist.map((mi) => (
            <div className='ml-[90px] cursor-pointer'>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{mi.discount}</button>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[605px] mt-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] ml-[605px] mt-[460px] hover:text-green-500' /></Link>
              <img src={mi.img} className=' h-[500px] w-[650px]' />
              <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px] ml-[30px]'> {mi.category}</p>
              <h1 className='hover:text-[#9ca887] text-4xl font-medium ml-[30px]' >{mi.title}</h1>
              <button className=' bg-lime-300 w-[120px] hover:text-[#9ca887]  ml-[30px]'>{mi.button}</button>
              <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[-15px] ml-[30px]'>{mi.price}</h1>
            </div>
          ))}
        </div>
        <div className='flex mt-[100px] w-[1400px]'>
          ...
          {maska.map((mas) => (
            <div key={mas.id} className='ml-[60px] w-[300px] cursor-pointer'>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 ml-[265px] mt-[10px] w-[20px] h-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{mas.discount}</button>
              <img src={imageHovered === 'night' ? mas.imgAlt : mas.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('night')} onMouseLeave={handleMouseLeave} />
          ...
          {bele.map((be) => (
            <div key={be.id} className='w-[300px] ml-[60px] cursor-pointer' onMouseEnter={() => handleMouseEnter('sumka')} onMouseLeave={handleMouseLeave}>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[265px] mt-[10px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{be.discount}</button>
              <img src={imageHovered === 'sumka' ? be.imgAlt : be.img} className='w-[300px] h-[240px]' />
          ...
          {music.map((mu) => (
            <div key={mu.id} className='ml-[60px] w-[300px] cursor-pointer'>
              <Link to="/favorites"><IoHeartOutline className='absolute ml-[265px] hover:text-red-500 mt-[10px] w-[20px] h-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute ml-[265px] mt-[205px] hover:text-green-500 w-[20px] h-[20px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] w-[40px] h-[40px] font-bold absolute'>{mu.discount}</button>
              <img src={imageHovered === 'шампунь' ? mu.imgAlt : mu.img} className='w-[300px] h-[240px] ' onMouseEnter={() => handleMouseEnter('шампунь')} onMouseLeave={handleMouseLeave} />
        ...
        <div className='flex mt-[100px] '>
          {balzam.map((bal) => (
            <div key={bal.id} className='w-[300px] cursor-pointer'>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[265px] mt-[10px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{bal.discount}</button>
              <img src={imageHovered === 'bee' ? bal.imgAlt : bal.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('bee')} onMouseLeave={handleMouseLeave} />
              <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'rtl', textAlign: 'right' }}>{bal.category}</h3>
              <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'rtl', textAlign: 'right' }}>{bal.title}</h1>
              <button className=' bg-lime-300 w-[120px] hover:text-[#9ca887]  ml-[180px] mt-[5px]'>{bal.button}</button>
              <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[230px] mt-[-15px]'>{bal.price}</h1>
            </div>
          ))}
          {vitam.map((sam) => (
            <div key={sam.id} className='w-[300px] ml-[60px] cursor-pointer'>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[265px] mt-[10px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{sam.discount}</button>
              <img src={imageHovered === 'termo' ? sam.imgAlt : sam.img} className='w-[300px] h-[240px]' onMouseEnter={() => handleMouseEnter('termo')}
          ...
          {shamp.map((sam) => (
            <div key={sam.id} className='ml-[90px] '>
              <Link to="/favorites"><IoHeartOutline className='absolute hover:text-red-500 w-[20px] h-[20px] ml-[605px] mt-[20px]' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] hover:text-green-500 ml-[605px] mt-[460px]' /></Link>
              <img src={sam.img} className='h-[500px] w-[650px]' />
              <p className='hover:text-[#9ca887] absolute font-mono mt-[-20px]  ml-[20px]'>{sam.category}</p>
              <h1 className='hover:text-[#9ca887] text-4xl font-medium  ml-[10px]'>{sam.title}</h1>
              <h1 className='font-bold hover:text-[#9ca887] text-2xl ml-[10px] mt-[10px]'>{sam.price}</h1>
            </div>
          ))}
        </div>
        <div className='flex mt-[100px]'>
          ...
          {pled.map((pd) => (
            <div key={pd.id} className='w-[300px] ml-[90px] cursor-pointer' onMouseEnter={() => handleMouseEnter('fen')} onMouseLeave={handleMouseLeave}>
              <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] h-[20px] hover:text-red-500 mt-[10px]  ml-[265px] ' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
              <button className=' font-bold w-[40px] absolute bg-[#ede370] text-[#221d1d] h-[40px]'>{pd.discount}</button>
              <img src={imageHovered === 'fen' ? pd.imgAlt : pd.img} className='w-[300px] h-[240px]' />
              <h3 className='hover:text-[#9ca887] font-mono mt-[5px]' style={{ direction: 'ltr', textAlign: 'left' }}>{pd.category}</h3>
              <h1 className='hover:text-[#9ca887] font-medium text-2xl' style={{ direction: 'ltr', textAlign: 'left' }}>{pd.title}</h1>
              <h1 className='font-bold hover:text-[#9ca887] text-2xl mt-[5px] '>{pd.price}</h1>
          ...
          {sergi.map((ser) => (
            <div key={ser.id} className='w-[300px] ml-[60px] cursor-pointer' onMouseEnter={() => handleMouseEnter('piala')} onMouseLeave={handleMouseLeave}>
              <Link to="/favorites"><IoHeartOutline className='absolute w-[20px] hover:text-red-500 h-[20px] mt-[10px]  ml-[265px] ' /></Link>
              <Link to="/cart"><BsBasket className='absolute w-[20px] h-[20px] mt-[205px] hover:text-green-500 ml-[265px]' /></Link>
              <button className='bg-[#ede370] text-[#221d1d] font-bold w-[40px] absolute h-[40px]'>{ser.discount}</button>
              <img src={imageHovered === 'piala' ? ser.imgAlt : ser.img} className='w-[300px] h-[240px]' />
